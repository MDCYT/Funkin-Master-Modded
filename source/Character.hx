	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'parents-christmas':
				...
				playAnim('idle');
			case 'morado':
				tex = Paths.getSparrowAtlas('morado_assets');
				frames = tex;
	
				animation.addByPrefix('idle', "morado IDLE", 24, false);
				animation.addByPrefix('singUP', "morado UP", 24, false);
				animation.addByPrefix('singDOWN', "morado DOWN", 24, false);
				animation.addByPrefix('singLEFT', 'morado LEFT', 24, false);
				animation.addByPrefix('singRIGHT', 'morado RIGHT', 24, false);
				...
				playAnim('idle');
			case 'azul':
				tex = Paths.getSparrowAtlas('azul_assets');
				frames = tex;
